...
Key takeaway: The commonly cited -4% accuracy for Customer Lookalike was achieved by (a) filtering to 40k high-risk customers and (b) applying a manually chosen 1.5x contamination multiplier calibrated against the A/B result. The raw output was -36%. This is not independent validation. Unbiased accuracy requires A/A testing and RCT calibration without post-hoc tuning.
